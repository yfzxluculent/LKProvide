...
@interface LKMp3Recorder()<AVAudioRecorderDelegate>

@end
@implementation LKMp3Recorder
...
- (NSString *)mp3Path {
    NSString *mp3Path = [[NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES) firstObject] stringByAppendingPathComponent:@"LKMp3Recorder.audioCache"];
